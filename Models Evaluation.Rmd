...
```{r}
# Expected Outcome
melt(rbind(rzp_tree_exp_conv[, c("Percentile","Model","Expected Outcome")], rzp_tree_exp_conv_Simple[, c("Percentile","Model","Expected Outcome")]), id.vars = c("Percentile","Model")) %>% ggplot(aes(x = Percentile)) +
  geom_line(aes(y = value, group= Model, color= Model) ) +
  labs(
    color="Model",
