...
```{r fit_tree, eval=F}
start_time <- Sys.time()
default_forest <- build_forest(train,val,treatment_list,response,'control',n_trees = 50,n_features = 4,criterion = 1, pruning = T)
...
parallel_time <- difftime(Sys.time(), start_time, units='mins')
