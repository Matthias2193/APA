...
colnames(random_conv_mat)[2] <- colnames(rzp_tree_mat_conv)[2] <- colnames(c_tree_mat_conv)[2] <- colnames(c_forest_mat_conv)[2] <- "Mens E-Mail"
colnames(random_conv_mat)[3] <-colnames(rzp_tree_mat_conv)[3] <- colnames(c_tree_mat_conv)[3] <- colnames(c_forest_mat_conv)[3] <- "Womens E-Mail"
